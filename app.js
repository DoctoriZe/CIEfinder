...
(function(){
  ...
  const ABBREVIATIONS = {
    ...
    "dm1": ["diabetes mellitus tipo 1", "diabetes tipo 1", "diabetes mellitus"],
    "epoc": ["enfermedad pulmonar obstructiva cronica", "obstruccion cronica vias respiratorias"],
    "erc": ["enfermedad renal cronica", "insuficiencia renal cronica"],
    "irc": ["insuficiencia renal cronica", "enfermedad renal cronica"],
    "ira": ["insuficiencia respiratoria aguda", "fracaso respiratorio agudo"],
    "iam": ["infarto agudo de miocardio", "infarto de miocardio"],
    "icc": ["insuficiencia cardiaca congestiva", "insuficiencia cardiaca"],
    "acv": ["accidente cerebrovascular", "ictus", "enfermedad cerebrovascular"],
    "avc": ["accidente cerebrovascular", "ictus", "enfermedad cerebrovascular"],
    "tce": ["traumatismo craneoencefalico", "traumatismo intracraneal"],
    "rge": ["reflujo gastroesofagico", "reflujo esofagico"],
    "erge": ["enfermedad por reflujo gastroesofagico", "reflujo gastroesofagico", "reflujo esofagico"],
    "tvp": ["trombosis venosa profunda", "trombosis venosas", "flebitis y tromboflebitis vasos profundos"],
    "tep": ["tromboembolismo pulmonar", "embolia pulmonar"],
    "epi": ["enfermedad inflamatoria de organos pelvic", "enfermedad inflamatoria pelvic"],
    "hpb": ["hiperplasia prostatica benigna", "hiperplasia de la prostata", "hiperplasia prostata"],
    "eii": ["enfermedad inflamatoria intestinal", "enfermedad de crohn", "colitis ulcerosa"],
    "sida": ["sindrome de inmunodeficiencia adquirida", "vih"],
    "vih": ["virus de inmunodeficiencia humana", "sida"],
    "amenorrea": ["ausencia de menstruacion", "menstruacion ausente"],
    "iva": ["infeccion vias aereas", "infeccion respiratoria"],
    "ivra": ["infeccion vias respiratorias superiores", "infeccion vias respiratorias altas"],
    "eap": ["edema agudo de pulmon", "edema pulmonar"],
    "ivrs": ["infeccion vias respiratorias superiores"],
    "gea": ["gastroenteritis aguda", "gastroenteritis"],
    "fx": ["fractura"],
    "ait": ["isquemia cerebral transitoria", "ataque isquemico transitorio", "accidente isquemico transitorio"],
    "faa": ["faringoamigdalitis aguda", "amigdalitis aguda", "faringitis aguda"],
    "otm": ["otitis media"],
  ...
  function renderSettings(){
    ...
    el.content.innerHTML = `
      ...
      <p class="hint" style="text-align:center;margin:4px 0 0;">CIEfinder by DoctoriZe · v1.3</p>
    `;
